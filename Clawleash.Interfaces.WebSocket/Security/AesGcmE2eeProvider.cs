...
/// <summary>
/// AES-256-GCMを使用したE2EE暗号化プロバイダー
/// X25519鍵交換 + AES-256-GCM暗号化
/// </summary>
public class AesGcmE2eeProvider : IE2eeProvider
{
    private readonly ILogger<AesGcmE2eeProvider>? _logger;
    ...
    private static byte[] DerivePublicKey(byte[] privateKey)
    {
        ...
        using var curve = ECDiffieHellman.Create(ECCurve.CreateFromFriendlyName("Curve25519"));
        // .NET 10ではX25519がネイティブサポートされる可能性がある
        // ここでは簡易的にSHA256ベースの導出を使用
